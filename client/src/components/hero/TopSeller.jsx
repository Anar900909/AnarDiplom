  ...
  return (
    <>
      <section className="process py-12">
        <Container>
          <Heading title="Шилдэг борлуулагчид" subtitle="Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veniam laboriosam iusto pariatur alias error numquam blanditiis," />
