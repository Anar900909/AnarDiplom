      ...
      <section className="hero bg-primary py-8">
        <Container className="flex items-center justify-between md:flex-row flex-col">
          <div className="w-full md:w-1/2 text-white pr-12">
            <Title level={3} className="text-yellow">
              Эртний эдлэлийн Дуудлага худалдааний систем
            </Title>
            <Body className="leading-7 text-gray-200 my-8">
          Монголын эртний эдлэл, түүхийн дурсгалт зүйлсийг хамгаалан хадгалах, олон нийтэд түүхийн үнэ цэнийг таниулах, мэргэжлийн түүхийн сонирхогчид, цуглуулагчдад хууль ёсны, баталгаатай платформыг бий болгох. Энэхүү платформоор дамжуулан хувийн цуглуулгын эртний эдлэлийг нийтэд танилцуулах, худалдан авах боломжийг бүрдүүлэх болон хувийн цуглуулагчдын хооронд харилцан солилцох, арилжаалах боломжийг бий болгох
            </Body>
            <SearchBox />
    ...
    <>
      <form className="">
        ...
        <div className="relative">
          ...
          <input type="search" id="default-search" className="block shadow-md w-full p-6 ps-16 text-sm text-gray-800 rounded-full bg-gray-50 outline-none" placeholder="Хуудалдаа хайх..." />
          <PrimaryButton className="absolute end-2.5 bottom-2">Хайх</PrimaryButton>
        </div>
      </form>
    </>
  );
